...
const UsuarioInvitar = ({ id, onPress }) => {
    ...
    return (
        <TouchableOpacity onPress={onPress} style={styles.outerContainer}>
            <View style={styles.innerContainer}>
                <Image source={{ uri: `${BASE_URL}${data.usuario.imagen_url}` }} style={styles.profileImage} />
                <Text style={styles.userName}>{data.usuario.nombre_usuario}</Text>
            </View>
        </TouchableOpacity>
    );
};
